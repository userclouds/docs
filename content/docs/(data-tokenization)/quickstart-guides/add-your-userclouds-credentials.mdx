...
UserClouds is invite-only right now. If you don’t have an invite, please email [team@userclouds.com.](mailto:team@userclouds.com.) Click the link in your email invite and create a username and password. 
...
![After creating your company and tenant, select your tenant from the top nav and copy the URL from the "Tenant Details" card.](https://files.readme.io/de1128a-image.png)
...
To learn more about authenticating to UserClouds APIs, see the API reference article on [Connecting to Our APIs](https://docs.userclouds.com/reference/api-authorization-1).
