...
slug: "create-an-access-policy-copy"
excerpt: ""
hidden: false
createdAt: "Fri Aug 25 2023 22:04:47 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Jun 20 2024 23:52:02 GMT+0000 (Coordinated Universal Time)"
---
## Introduction

Access policies control the circumstances in which tokens can be exchanged for the raw data. Practically, access policies are functions that receive contextual data and return true or false according to whether access is allowed or denied. For more info, see [Access Policies Definition](https://docs.userclouds.com/docs/access-policies-1) .
