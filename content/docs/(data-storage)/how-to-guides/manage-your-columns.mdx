...
- **Data Type**: Specifies the type of data the column holds, supporting both basic and composite data types. For more info, see our [Data Types Documentation](https://docs.userclouds.com/docs/data-types-1)
...
To learn how to manage columns via the UserClouds API, consult our [API Reference](https://docs.userclouds.com/reference/post_userstore-config-columns).
