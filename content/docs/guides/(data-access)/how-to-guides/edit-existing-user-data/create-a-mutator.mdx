...
Mutators do not create users: they only add or edit values associated with existing users. You can create a user via the [CreateUserWithMutator](/docs/reference/post_userstore-api-users)  call. 
...
<Steps>
    ...
    <Step>
    Choose which records and columns it will write data for
    </Step>
    <Step>
...
To learn how to create a mutator via the UserClouds API, see our [API Reference](/docs/reference/post_userstore-config-mutators).
