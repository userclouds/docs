...
For more information on applying access policies that consider external sources, review the Built-in Functions section of the [Access Policy Documentation](/docs/access-policies-1#built-in-functions.).
