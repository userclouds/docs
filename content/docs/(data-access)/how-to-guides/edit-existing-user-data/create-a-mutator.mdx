...
Mutators do not create users: they only add or edit values associated with existing users. You can create a user via the [CreateUserWithMutator](/reference/post_userstore-api-users)  call. 
...
For more information on transformers, see [Transformers](/docs/transformers-1). For more information on creating transformers, see our [How To Guide on Creating Transformers](/docs/create-a-transformer).
...
For more information on what access policies do, see [Access Policies](/docs/access-policies-1). For more information on creating access policies, see our [How To Guide on Creating Access Policies](/docs/create-an-access-policy).
...
To learn how to create a mutator via the UserClouds API, see our [API Reference](/reference/post_userstore-config-mutators).
